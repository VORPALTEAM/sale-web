...
/* 
Position:
index.tsx:155 Vector3 {x: 20.891133788229407, y: 2.439057120737904, z: 21.125412273037703}
index.tsx:156 Rotation:
index.tsx:157 Euler {isEuler: true, _x: -0.26959227945499664, _y: 0.8081016242862483, _z: 0.1971767388635288, _order: 'XYZ', …}
index.tsx:158 Target: 
index.tsx:159 Vector3 {x: -0.7229769429728901, y: -0.18400583054107678, z: -0.6659175581530068}
*/

export const defaultCam: camObject = {
  position: {
    x: 20.891133788229407,
    y: 2.439057120737904,
    z: 21.125412273037703,
  },
  rotation: {
