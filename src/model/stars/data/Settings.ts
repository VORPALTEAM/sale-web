...
export class Settings {
    ...
    static domCanvasParent: HTMLElement | null = null;
    static domTouchParent: HTMLElement | null = null;
    static domGuiParent: HTMLElement | null = null;
    static domRenderer: HTMLElement | null = null;
